var ColourManager = {
	...
	initColourStyleCSS: function() {
		...
		self.redGreenCSS = "#comparison-panel .card .more { color: #FE4365; }" +
						   ...
						   "#comparison-panel .card .back .similar.content .count { fill: #FE4365; }" +
						   ...
						   "#comparison-panel .card .back .different.content .count { fill: #83AF9B; }";
		self.colourBlindCSS = "#comparison-panel .card .more { color: #ef8a62; }" +
						      ...
						      "#comparison-panel .card .back .similar.content .count { fill: #ef8a62; }" +
						      ...
						      "#comparison-panel .card .back .different.content .count { fill: #67a9cf; }";
	}
}